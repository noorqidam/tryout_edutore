      ...
      <div v-if="UserHasLogin" class="container-fluid">
        <div class="row flex-xl-nowrap2">
          ...
          <nav id="realAns" aria-label="Secondary navigation" aria-hidden="true" class="bd-toc col-xl-2 d-none d-xl-block">
            <ul v-for="ans in Useranswer" :key="ans.email" class="nav section-nav flex-column" style="max-heigth:500px">
...
export default {
  ...
  methods: {
    ...
    _actionGetQuestion (id) {
      ...
      this.$axios.post('soal-quiz-peserta', data, { headers: { 'x-access-token': this.token } })
        .then((response) => {
