                ...
                <div class="icon-desc">
                  ...
                  <div @click="likes(modules.id)" class="desc-icon love-icon float-right ">
                    <p class="ico-heart-module">
                      <i v-bind:class="isLiked ? 'heart-ico': '' " class="fas fa-heart" />
                      {{ modules.like.likes }}
                    </p>
                  </div>
                </div>
                ...
                <div v-if="item.paket_soals.length !== 0" class="tema-reg__box">
                  <a>
                    ...
                    <div class="star-reg-box">
                      <i class="star-kosong fa fa-star" style="color:gold" />
                      <i class="star-kosong fa fa-star" style="color:gold" />
                      <i class="star-kosong fa fa-star" style="color:gold" />
                      <i class="star-kosong fa fa-star" style="color:gold" />
                      <i class="star-kosong fa fa-star" style="color:gold" />
  ...
  methods: {
    ...
    submitPaketSoals (ThemaId, paketId) {
      this.$router.push({
        ...
        query: { ps_id: paketId, slug: this.slug, id_subs: this.idSubscription }
      })
    },
    likes (id) {
