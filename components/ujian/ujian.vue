            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="text-center">
                  <router-link
                    v-if="item.type_ujian =='BERSAMA'"
                    :to="{ path :'/ujian/'+item.ujian_slug ,query: { id:item._id}}"
                    class="btn button-detail"
                  >
                  ...
                  <router-link
                    v-else
                    :to="{ path :'/ujian/mandiri/'+item.ujian_slug , query: { id:item._id}}"
                    class="btn button-detail"
                  >
                    <p class="text-center title-button-detail">
                      Lihat Detail
